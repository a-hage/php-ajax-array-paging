...
function getAllProducts($product_filter, $products, $per_page, $current_page, $kunde){
...
if($_POST['paging_function_name'] == 'getAllProducts'){
    include('products-module.php');
    $products_filter = $_POST['paging_products_filter'];
    $products = unserialize($_POST['paging_products']);
    $per_page = $_POST['paging_per_page'];
    $current_page = $_POST['paging_currentPage'];
    $kunde = $_POST['paging_kunde'];
    echo getAllProducts($product_filter, $products, $per_page, $current_page, $kunde);
    exit(0);
}
?>
